...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, getProductData, order, user  } = context

    useEffect(() => {
        getProductData(); // Now safe to call
    }, []);
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                    <Link to={'/addproduct'}>
                                        <button
                                            type="button"
                                            className="focus:outline-none text-white bg-blue-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-blue-800 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {Array.isArray(product) ? product.map((item, index) => {
                                            ...
                                            return (
                                                <tbody key={item.id} className='bg-gray-50 border-b dark:border-gray-700' >
